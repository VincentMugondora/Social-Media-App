...
const Login = () => {
  ...
  return (
    <div classNameName="bg-bgColor w-full h-[100vh] flex items-center justify-center p-6">
      <div classNameName="w-full md:w-2/3 h-fit lg:h-full 2xl:h-5/6 py-8 lg:py-0 flex bg-primary rounded-xl overflow-hidden shadow-xl">
        {/* LEFT */}
        <div classNameName="w-full lg:w-1/2 h-full p-10 2xl:px-20 flex flex-col justify-center ">
          ...
          <span classNameName="text-sm mt-2 text-ascent-2">Welcome back</span>
          ...
          >
            ...
            <Link
              to="/reset-password"
              classNameName="text-sm text-right text-blue font-semibold"
            >
              Forgot Password ?
            </Link>
